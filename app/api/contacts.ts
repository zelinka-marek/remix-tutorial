...
const fakeContacts = {
  ...
  getAll: async (): Promise<ContactRecord[]> => {
    return Object.keys(fakeContacts.records)
      .map((key) => fakeContacts.records[key])
      .sort(sortBy("-createdAt", "last"));
  },

  get: async (id: string): Promise<ContactRecord | null> => {
    return fakeContacts.records[id] || null;
  },

  create: async (values: ContactMutation): Promise<ContactRecord> => {
  ...
  set: async (id: string, values: ContactMutation): Promise<ContactRecord> => {
